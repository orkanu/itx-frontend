...
jest.mock('@/services/phonesListService.ts', () => ({
  fetchListPhones: jest.fn(),
}))
...
describe('PhonesList', () => {
  ...
  it('shows loading state initially and then renders items on success', async () => {
    fetchListPhones.mockResolvedValueOnce([
  ...
  it('renders error state and allows retry on failure', async () => {
    fetchListPhones
      ...
      .mockResolvedValueOnce([{ id: '1', brand: 'Xiaomi', model: 'Mi 13', price: 599, imgUrl: 'xiaomi.jpg' }])
